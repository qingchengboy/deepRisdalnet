...
NUM_TRAIN_BATCH = 4 # How many batches of files you want to read in, from 0 to 5) 5
EPOCH_SIZE = 200 * NUM_TRAIN_BATCH #10000
...
def _read_one_batch(path, is_random_label):
    ...
    if is_random_label is False:
        ...
        labels = np.random.randint(low=0, high=10, size=200)#10000
