...
tf.app.flags.DEFINE_integer('train_steps', 6000, '''Total steps that you want to train''')#80000
tf.app.flags.DEFINE_boolean('is_full_validation', True, '''Validation w/ full validation set or
a random batch''')
tf.app.flags.DEFINE_integer('train_batch_size', 125, '''Train batch size''')
...
tf.app.flags.DEFINE_integer('test_batch_size', 125, '''Test batch size''')#125
...
tf.app.flags.DEFINE_string('ckpt_path', './trained/model.ckpt-100000', '''Checkpoint
