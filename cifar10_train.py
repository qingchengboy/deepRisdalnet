...
class Train(object):
    ...
    def train(self):
        ...
        for step in xrange(FLAGS.train_steps):
            ...
            if step % 2000 == 0 or (step + 1) == FLAGS.train_steps:#10000
    ...
    def loss(self, logits, labels):
        ...
        cross_entropy = tf.nn.sparse_softmax_cross_entropy_with_logits(None,labels,logits, name='cross_entropy_per_example')
    ...
    def generate_vali_batch(self, vali_data, vali_label, vali_batch_size):
        ...
        '''
        offset = np.random.choice(200 - vali_batch_size, 1)[0] #10000
    ...
    def full_validation(self, loss, top1_error, session, vali_data, vali_labels, batch_data,
        ...
        :return: float, float
        '''
        num_batches = 200 // FLAGS.validation_batch_size #10000
        order = np.random.choice(200, num_batches * FLAGS.validation_batch_size)
